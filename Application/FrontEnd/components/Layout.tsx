// Application layout component for pages
// - renders header with navigation and actions
// - provides a main content area and a footer
// Note: keep this file ASCII-only to avoid encoding issues in some tools.
